  ...
  <section id="home" class="hero section">
    <div class="container">
      ...
      <div class="hero-text">
        ...
        <a href="#" class="btn btn-hover">JOIN NOW</a>
      </div>
    </div>
  </section>
      ...
      <div class="row g-4 mt-4">
        ...
        <div class="col-md-4">
          <div class="card text-start">
            ...
            <p class="info">Perfect for beginners</p>
            <h2 class="mb-2">₹999</h2>
            <p class="para mb-2" style="opacity: 0.4">/month</p>
            ...
            <ul class="list-unstyled" style="margin-top: 10px">
              ...
              <li class="not-included">
                <i class="bi bi-x-circle me-2"></i>Personal Trainer
              </li>

              <li class="not-included">
                <i class="bi bi-x-circle me-2"></i>Diet Plan
              </li>

              <li class="not-included">
                <i class="bi bi-x-circle me-2"></i>Supplements Guidance
              </li>
            </ul>
            <a href="#" class="btn btn-butt mt-3 w-100">Get Started</a>
          </div>
        </div>

        <!-- Second Card -->
        <div class="col-md-4">
          <div class="card text-start popular">
            <div class="badge-popular">MOST POPULAR</div>
            <h5 class="mb-4">Pro Plan</h5>
            <p class="info">Best for serious athletes</p>
            <h2 class="mb-2">₹1999</h2>
            <p class="para mb-2" style="opacity: 0.4">/month</p>
            <p class="duration">30 Days Access</p>
            <ul class="list-unstyled" style="margin-top: 15px">
              ...
              <li><i class="bi bi-check-circle me-2"></i>Personal Trainer</li>

              <li><i class="bi bi-check-circle me-2"></i>Diet Plan</li>
        ...
        <div class="col-md-4">
          <div class="card text-start">
            <h5 class="mb-4">Elite Plan</h5>
            <p class="info">Complete Transformation</p>
            <h2 class="mb-2">₹3,499</h2>
            <p class="para mb-2" style="opacity: 0.4">/month</p>
            <p class="duration">30 Days Access</p>
            <ul class="list-unstyled" style="margin-top: 10px">
              <li><i class="bi bi-check-circle me-2"></i>Gym Access</li>
              ...
              <li>
                <i class="bi bi-check-circle me-2"></i>Supplement Guidance
              </li>
            </ul>
            <a href="#" class="btn btn-butt mt-3 w-100">Get Started</a>
          </div>
      ...
      <div class="row g-4 mt-4">
        ...
        <div class="col-md-3">
          <div class="trainer-card-pro">
            <div class="trainer-img-container">
              <img src="https://res.cloudinary.com/de029k6ik/image/upload/f_auto,q_auto/trainer_tfg7f9"
                class="img-fluid" />
            </div>

            <div class="trainer-details text-start">
              <h3 class="mb-1 text-uppercase">Gaurav Singh Chandel</h3>
              <span class="specialty">Strength & Conditioning</span>

              <p class="bio">
                Specializing in muscle hypertrophy and powerlifting with over
                4 years of hands-on coaching experience.
              </p>
              <span class="badge-popular-trainer">Powerlifting</span>
              <span class="badge-popular-trainer">Muscle Gain</span>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="trainer-card-pro">
            <div class="trainer-img-container">
              <img
                src="https://res.cloudinary.com/de029k6ik/image/upload/f_auto,q_auto/WhatsApp_Image_2026-04-10_at_9.09.40_PM_zy1spo"
                class="img-fluid" />
            </div>

            <div class="trainer-details text-start">
              <h3 class="mb-1 text-uppercase">Lakshay At</h3>
              <span class="specialty">Strength & Conditioning</span>
